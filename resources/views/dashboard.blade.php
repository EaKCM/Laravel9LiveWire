...
<header class="flex items-center justify-between w-full">
    <div class="flex items-center">
        ...
        <img src="{{ Auth::user()->profile_photo_path != null ?  asset('storage/'.Auth::user()->profile_photo_path) : asset('storage/nopic1.png')}}" class="rounded-full h-14 w-14" alt="User Avatar">
